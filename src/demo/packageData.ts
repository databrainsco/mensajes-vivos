  ...
  return {
    ...
    lugares: {
      ...
      hallazgo: input.hallazgo ?? {
        etiqueta: 'Mesoamérica (varios contextos documentados)',
        certeza: 'aproximada',
      },
...
export const PIECES: PieceCard[] = [
  ...
  piece({
    ...
    cultura: 'Mexica (colonial temprano)',
    periodo: 'Siglo XVI',
    tipo_objeto: 'codice',
  ...
  piece({
    ...
    cultura: 'Nahua / mixteca-puebla',
    periodo: 'Posclásico / colonial temprano',
    tipo_objeto: 'codice',
    clip_label: 'Codex Borgia Mesoamerican painted screenfold ritual manuscript with deities and tonalamatl',
    sala: 'Códices',
  ...
  piece({
    ...
    periodo: 'Posclásico',
    tipo_objeto: 'codice',
    clip_label: 'Codex Vaticanus B Mesoamerican ritual painted manuscript tonalamatl deities',
    sala: 'Códices',
  ...
  piece({
    ...
    cultura: 'Tlaxcalteca / novohispano',
    periodo: 'Siglo XVI',
    tipo_objeto: 'codice',
  ...
  piece({
    ...
    id: 'huehueteotl',
    nombre: 'Huehuetéotl',
    cultura: 'Altiplano / Teotihuacan–Mexica',
    periodo: 'Clásico–Posclásico',
    tipo_objeto: 'deidad',
  ...
  piece({
    ...
    resumen: 'Una de las pirámides más grandes de Mesoamérica, eje del paisaje ritual de Teotihuacan.',
  ...
  piece({
    ...
    periodo: 'Preclásico–Posclásico',
    tipo_objeto: 'objeto_desconocido',
    clip_label: 'Mesoamerican solid rubber ball for ballgame ulama archaeological artifact',
    sala: 'Juego de pelota',
    resumen: 'Pelota de hule del juego ritual mesoamericano. Objeto central de canchas y mitología.',
  }),
  piece({
    seed: 276,
    id: 'espejo-obsidiana',
  ...
  piece({
    ...
    periodo: 'Preclásico–Posclásico',
    tipo_objeto: 'objeto_desconocido',
    clip_label: 'Mesoamerican obsidian prismatic blade sharp black volcanic glass tool',
    sala: 'Tecnología',
    resumen: 'Hojas prismáticas de obsidiana, tecnología lítica extendida en Mesoamérica para corte y ritual.',
  }),
  piece({
    seed: 278,
  ...
  piece({
    ...
    periodo: 'Clásico–Posclásico',
    tipo_objeto: 'instrumento',
    clip_label: 'Mesoamerican ceramic clay flute ocarina pre-Hispanic musical instrument',
    sala: 'Instrumentos',
...
export const MANIFEST: PackageManifest = {
  ...
  roomName: 'Catálogo mesoamericano ampliado',
  checksum: 'demo-sha256-mesoamerica-v2',
...
export const GLOSSARY: Record<string, string> = {
  ...
  quetzalcoatl: 'Serpiente emplumada; deidad y símbolo panmesoamericano.',
